...
data_total_R <- sji.SPSS("C:\\Project\\data_total_SAV.sav", 
...
sjt.xtab(data_total_R$Mosaic_media_frequency_0_NET, 
         data_total_R$FacebookFriendsQuintiles, # create a crosstab for these two variables
         showExpected=F, 
         showRowPerc=F, 
         showCellPerc=F, 
         showColPerc=T, 
...
sjt.xtab(data_total_R$Mosaic_media_frequency_0_NET, 
         data_total_R$FacebookVisitsQuintiles, 
         showExpected=F, 
         showRowPerc=F, 
         showCellPerc=F, 
         showColPerc=T, 
...
sjt.xtab(data_total_R$Mosaic_media_frequency_1_NET, 
         data_total_R$FacebookFriendsQuintiles, 
         showExpected=F, 
         showRowPerc=F, 
         showCellPerc=F, 
         showColPerc=T, 
...
sjt.xtab(data_total_R$Mosaic_media_frequency_4_NET, 
         data_total_R$FacebookFriendsQuintiles, 
         showExpected=F, 
         showRowPerc=F, 
         showCellPerc=F, 
...
sjt.xtab(data_total_R$Mosaic_SocialMedia_FrequencyVisit_0_NET, 
         data_total_R$FacebookFriendsQuintiles, 
         showExpected=F, 
         showRowPerc=F, 
         showCellPerc=F, 
